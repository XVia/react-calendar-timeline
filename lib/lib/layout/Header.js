...
var Header = function (_Component) {
  ...
  _createClass(Header, [{
    ...
    value: function __periodClick__REACT_HOT_LOADER__(e) {
      ...
      if (time && unit) {
        this.props.onHeaderClick((0, _moment2.default)(time - 0), unit, e);
      }
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { ref: 'header', key: 'header', className: 'rct-header', onTouchStart: this.touchStart, onTouchEnd: this.touchEnd, onClick: this.onHeaderClick, style: headerStyle },
        timeLabels
      );
    }
  }]);
