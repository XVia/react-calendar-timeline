...
var ReactCalendarTimeline = function (_Component) {
  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    value: function __scrollEventListener__REACT_HOT_LOADER__(e) {
      ...
      var topOffset = stickyOffset ? stickyOffset : 0;
    ...
    key: '__onHeaderClick__REACT_HOT_LOADER__',
    ...
    value: function __onHeaderClick__REACT_HOT_LOADER__(from, unit, e) {
    ...
    value: function header(canvasTimeStart, zoom, canvasTimeEnd, canvasWidth, minUnit, timeSteps, headerLabelGroupHeight, headerLabelHeight) {
      return _react2.default.createElement(_Header2.default, { onHeaderClick: this.props.onHeaderClick,
        canvasTimeStart: canvasTimeStart,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onHeaderClick = function () {
    return _this2.__onHeaderClick__REACT_HOT_LOADER__.apply(_this2, arguments);
  };
